...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('language.Roles') }}
                ...
                <div class="table-responsive">
                    <div class="card-body">
                        <table class="table table-light table-striped table-bordered table-hover">
                            ...
                            <tbody>
                                @foreach($fetchRoles as $key => $show)
                                <tr>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group row">
                    ...
                    {!! Form::label('role', 'Role Name', ['class' => 'col-md-4 col-form-label text-md-right']) !!}
                    <div class="col-md-8">
                        {!! Form::text('name', 'Role', ['class' => 'form-control']); !!}
                    </div>
                    <div class="col-md-8">
